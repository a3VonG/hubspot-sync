...
DISPOSABLE_EMAIL_DOMAINS = {
    ...
    # Random/generated domains discovered in production
    "juhxs.com",
...
def is_disposable_email_domain(email: str) -> bool:
    ...
    Checks both our curated list and the disposable-email-domains package blocklist.
    """
    if not email or "@" not in email:
        return False
    domain = email.lower().split("@")[-1]
    return domain in DISPOSABLE_EMAIL_DOMAINS or domain in _disposable_blocklist
