...
class OrganizationSyncOrchestrator:
    ...
    def _process_organization(self, org: Organization):
        ...
        if match_result.match_type == MatchType.ALREADY_LINKED:
            ...
            self._handle_multiple_matches(org, match_result)
        elif match_result.match_type == MatchType.NEEDS_REVIEW:
            self._handle_needs_review(org, match_result)
    ...
    def _handle_already_linked(self, org: Organization, match_result: MatchResult, has_subscription: bool):
        """Handle already linked organization."""
    ...
    def _handle_multiple_matches(self, org: Organization, match_result: MatchResult):
    ...
    def _handle_needs_review(self, org: Organization, match_result: MatchResult):
...
def main():
    ...
    parser.add_argument("--org-id", help="Sync specific organization by ID")
